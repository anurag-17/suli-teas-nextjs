              ...
              <div className=" mx-auto 2xl:mt-[74px] xl:mt-10 lg:mt-8 md:mt-4 sm:mt-4 mt-3">
                <div className="flex  flex-wrap 2xl:gap-20 justify-center lg:justify-between md:flex-row md:gap-8 flex-col sm:gap-6 gap-6 ">
                  ...
                  >
                    ...
                    <h1
                      id="head"
                      className="text-[#1E1E1E] text-center 2xl:text-[24px] 2xl:mt-[18px] 2xl:leading-[50px]  xl:text-[16px] xl:my-2 xl:leading-[35px] lg:my-2 lg:text-[14px]  lg:leading-[25px] md:text-[16px] md:my-1  md:leading-[25px] sm:text-[14px] sm:mt-1 sm:leading-[30px]  text-[10px] mt-1  leading-[20px] product-name"
                    >
                      Weight Wonder
                    </h1>
                    <h1
                      id="head"
                      className="text-center 2xl:my-3  2xl:text-[36px] 2xl:leading-[25px]  xl:text-[22px] xl:my-2 xl:leading-[20px] lg:text-[20px]  lg:leading-[25px] md:text-[18px] md:my-1 md:leading-[25px] sm:text-[18px] sm:leading-[25px]   text-[14px] product-price"
                    >
                      $17.00
                    </h1>
                  </div>
                  ...
                  <div
                    data-aos="zoom-out-up"
                    className="2xl:mb-8 2xl:w-[446px] xl:w-[280px] 2xl:mt-3  xl:mt-2  lg:w-[200px] md:w-4/12 md:mx-0  sm:w-3/6  w-4/6 cursor-pointer mx-auto img-div"
                  >
                    <Image
                      src={ListingsFo}
                      className=" 2xl:w-full xl:w-full lg:w-full md:w-full sm:w-4/6 w-3/6 cursor-pointer mx-auto md:mx-0"
                    ...
                    <h1
                      id="head"
                      className="text-[#1E1E1E] text-center 2xl:text-[24px] 2xl:mt-[18px] 2xl:leading-[50px]  xl:text-[16px] xl:mt-2 xl:leading-[35px] lg:my-2 lg:text-[14px]  lg:leading-[25px] md:text-[16px] md:my-1  md:leading-[25px] sm:text-[14px] sm:mt-1 sm:leading-[30px]   text-[10px] mt-1  leading-[20px] product-name"
                    >
                      Champion Chai
                    </h1>
                    <h1
                      id="head"
                      className="text-center 2xl:my-12xl:my-3  2xl:text-[36px] 2xl:leading-[25px]  xl:text-[22px] xl:my-2 xl:leading-[20px] lg:text-[20px]  lg:leading-[25px] md:text-[18px] md:my-1 md:leading-[25px] sm:text-[18px] sm:leading-[25px]   text-[14px] product-price"
                    >
                      $17.00
                    </h1>
                  </div>
                  ...
                  >
                    ...
                    <h1
                      id="head"
                      className="text-[#1E1E1E] text-center 2xl:text-[24px] 2xl:mt-4 2xl:leading-[50px] xl:text-[16px] xl:my-2 xl:leading-[35px] lg:my-2 lg:text-[14px]  lg:leading-[25px] md:text-[16px] md:my-1  md:leading-[25px] sm:text-[14px] sm:mt-1 sm:leading-[30px]   text-[10px] mt-1  leading-[20px] product-name"
                    >
                      Anxiety Assist
                    </h1>
                    <h1
                  ...
                  >
                    ...
                    <h1
                      id="head"
                      className="text-center 2xl:text-[24px] 2xl:mt-[18px] 2xl:leading-[50px]   xl:text-[16px]  xl:leading-[35px] lg:text-[14px]  lg:leading-[25px] md:text-[16px]  md:leading-[25px] md:my-1 sm:text-[14px]  sm:leading-[30px]  text-[10px] mt-1  leading-[20px] product-name"
                    >
                      Immune Boost Beast
                    </h1>
                    <h1
          ...
          <div className=" sm:w-full mx-auto2xl:mt-36 2xl:mt-48 xl:mt-32 lg:mt-20 sm:mt mb-10 ">
            <div className=" 2xl:w-[1500px] xl:w-[1000px]  lg:w-[750px]  mx-auto  nav">
              ...
              >
                ...
                <div id="image2" className=" w-[30%] 2xl:w-[291px] 2xl:h-[291px] xl:w-[190px] xl:h-[190px] sm:w-44 mt-5 mx-auto lg:w-[140px] last-img">
                  <Image
                    id="img1"
                    src={aa}
          ...
          <footer className="bg-[#E9F5DE] 2xl:pt-[70px] 2xl:mt-[100px]   xl:pt-12 xl:mt-20  lg:pt-8 lg:mt-16 md:pt-10 md:mt-10 sm:pt-10 sm:mt-10 ">
            <div className="2xl:w-[1500px] xl:w-[1000px]  lg:w-[750px]   mx-auto lg:flex  lg:justify-around lg:flex-row  xl:flex xl:flex-row  2xl:mx-auto 2xl:flex 2xl:justify-around   2xl:mb-10 xl:mb-2 lg:mb-8 md:flex-col md:justify-center md:mb-10 sm:flex-col sm:justify-center sm:mb-5  flex-col justify-center nav">
              <div className="2xl:w-2/12 lg:w-2/12 xl:w-2/12 md:w-full sm:w-full pt-5 sm:pt-0 md:pt-0 lg:py-0">
                ...
                <h1
                  className="2xl:text-[40px] 2xl:mt-8 2xl:leading-[26px] xl:text-[30px] xl:leading-[20px] lg:text-left lg:text-[25px] lg:leading-[16px] lg:mt-6 md:text-[20px]  sm:text-[18px] sm:mb-5 text-[25px] text-center footer-logo"
                  id="nav-head"
                >
                  TEAS
                </h1>
