      ...
      <section>
        <div>
          ...
          <div className="flex justify-center 2xl:mt-24 xl:mt-16 lg:mt-16 md:mt-10 sm:mt-6 my-3">
            <div className="">
              <Image src={leaves} className="mx-auto 2xl:w-20 xl:w-16 md:w-12 sm:w-8 w-8" />
              <h1
                id="head"
              ...
              <div className=" w-10/12 mx-auto 2xl:mt-20 xl:mt-8 lg:mt-6 md:mt-4 sm:mt-4 mt-3">
                <div className="flex justify-center flex-wrap gap-4  sm:justify-around md:gap-6 sm:gap-6">
                  <div  data-aos="zoom-out-up" className="2xl:mb-8 xl:w-1/4 lg:w-1/4 md:w-2/6 sm:w-2/6 w-3/6">
              ...
              >
                ...
                <div className="flex justify-center 2xl:mt-4 xl:mt-1 lg:mt-1">
                  <div className="  w-3/12">
                    <h1
                      className="text-center  bg-[#5C161D] 2xl:my-32 text-white rounded-[8px]  2xl:w-7/12 2xl:py-4  2xl:text-[22px] 2xl:leading-[28px]  mx-auto  xl:py-3  xl:text-[14px] xl:leading-[20px] xl:mt-20  xl:w-7/12 lg:w-7/12 lg:py-2  lg:text-[12px] lg:leading-[20px] lg:mt-20 md:w-9/12 md:py-1  md:text-[14px] md:leading-[22px] md:mt-12   sm:py-1  sm:text-[14px] sm:leading-[15px] sm:mt-10  w-12/12 py-[6px]  text-[8px] leading-[10px] mt-10 "
                      id="head"
                    >
                      Immune Boost Beast
                    </h1>
                    <h1
                      className="2xl:my-32 text-white rounded-[8px] 2xl:w-7/12  2xl:py-4 text-center  bg-[#A47750] 2xl:text-[22px] 2xl:leading-[28px]  2xl:ml-6  xl:py-3  xl:text-[14px] xl:leading-[20px] xl:mt-16 xl:w-7/12 lg:py-2  lg:text-[12px] lg:leading-[20px] lg:mt-12  md:w-9/12 md:py-1  md:text-[14px] md:leading-[22px] md:mt-12  sm:w-8/12 sm:py-1  sm:text-[14px] sm:leading-[15px] sm:mt-8  py-[6px]  text-[8px] leading-[10px] mt-12 w-11/12 "
                      id="head"
                    >
                      Champion Chai
                    </h1>
                    <h1
                      className="2xl:my-32 text-white rounded-[8px]  w-11/12 2xl:py-4 text-center  bg-[#7A8654] 2xl:w-7/12 2xl:text-[22px] 2xl:leading-[28px]  mx-auto  xl:py-3  xl:text-[14px] xl:leading-[20px] xl:mt-16 xl:w-7/12 lg:py-2  lg:text-[12px] lg:leading-[20px] lg:mt-12  md:w-9/12 md:py-1  md:text-[14px] md:leading-[22px] md:mt-12   sm:w-8/12 sm:py-1  sm:text-[14px] sm:leading-[15px] sm:mt-8  py-[6px]  text-[8px] leading-[10px] mt-12"
                      id="head"
                    >
                      Weight Wonder
                    </h1>
                  </div>
                  <div  data-aos="zoom-out-up" className="border rounded-[14px] shadow-2xl 2xl:p-10 2xl:pb-3 w-5/12 sm:w-3/12 xl:px-10 xl:py-6 xl:pb-0 lg:px-6 lg:py-4 lg:pb-0 md:px-5 md:py-3 md:pb-0 sm:px-5 sm:py-3 sm:pb-0  px-3 py-1 pb-0 ">
                    <h1
                      id="head"
                  ...
                  <div className=" w-3/12">
                    <h1
                      className=" text-white  bg-[#32504D] text-center rounded-[8px] mx-auto w-11/12 2xl:w-7/12 2xl:my-32 2xl:py-4 2xl:text-[22px] 2xl:leading-[28px]  xl:mt-20 xl:py-3 xl:text-[14px] xl:leading-[20px] lg:mt-20 xl:w-7/12  lg:py-2 lg:text-[12px] lg:leading-[20px] md:w-9/12 md:py-1  md:text-[12px] md:leading-[22px] md:mt-12  sm:w-8/12 sm:py-1  sm:text-[14px] sm:leading-[15px] sm:mt-10  py-[6px]  text-[8px] leading-[10px] mt-10"
                      id="head"
                    >
                      Anxiety Assist
                    </h1>
                    <h1
                      className="  text-white rounded-[8px]  w-11/12 text-center  bg-[#482E69] 2xl:py-4 2xl:w-7/12  2xl:my-32 2xl:text-[22px] 2xl:leading-[28px] 2xl:ml-48  xl:mt-16 xl:py-3  xl:text-[14px] xl:leading-[20px ] xl:w-7/12 xl:ml-36   lg:mt-12 lg:py-2 lg:text-[12px] lg:leading-[20px] lg:ml-28  md:ml-16   md:w-9/12 md:py-1  md:text-[14px] md:leading-[22px] md:mt-12   sm:w-8/12 sm:py-1  sm:text-[14px] sm:leading-[15px] sm:mt-8 sm:ml-12  ml-2 py-[6px]  text-[8px] leading-[10px] mt-12"
                      id="head"
                    >
                      Flair Fighter
                    </h1>
                    <h1
                      className=" text-white rounded-[8px]  mx-auto  w-11/12 text-center  bg-[#7D062A] 2xl:w-7/12 2xl:py-4  2xl:my-32 2xl:text-[22px] 2xl:leading-[28px]  xl:mt-16 xl:py-3  xl:text-[14px] xl:leading-[20px] xl:w-7/12 lg:py-2 lg:my-32 lg:text-[12px] lg:leading-[20px] lg:mt-12 md:w-9/12 md:py-1  md:text-[14px] md:leading-[22px] md:mt-12  sm:w-8/12 sm:py-1  sm:text-[14px] sm:leading-[15px] sm:mt-8  py-[6px]  text-[8px] leading-[10px] mt-12"
                      id="head"
                    >
                      Detox Delite
                    </h1>
          ...
          <div className="w-2/4 sm:w-full mx-auto sm:flex sm:justify-center 2xl:mt-12 xl:mt-12 lg:mt-6 mb-10">
            <div className=" ">
              <div className="mt-12">
                ...
                <h1
                  className=" text-[30px] text-center 2xl:text-[60px] 2xl:leading-[70px] 2xl:mt-1 xl:text-[40px] xl:leading-[40px] xl:mt-1 lg:text-[30px] lg:leading-[30px] lg:mt-1 md:text-[30px] md:leading-[30px] md:mt-1  sm:text-[20px] sm:leading-[20px] leading-[35px]  sm:mt-1"
                  id="head"
                >
                  #SuliTeas
                </h1>
              ...
              <div  data-aos="fade-up" className="flex xl:w-10/12 xl:mx-auto  sm:flex-row gap-4 2xl:w-full 2xl:gap-4 xl:gap-4 2xl:mt-10 xl:mt-6 lg:mt-4 md:mt-2 sm:mt-1 mt-1 flex-col relative">
                <div id="image2">
                  <Image
                    id="img1"
                    src={aa}
          ...
          <footer className="bg-[#E9F5DE] 2xl:pt-24 2xl:mt-24 xl:pt-20 xl:mt-20  lg:pt-8 lg:mt-16 md:pt-10 md:mt-10 sm:pt-10 sm:mt-10 ">
            <div className="lg:flex lg:justify-around lg:flex-row  xl:flex xl:flex-row xl:justify-around 2xl:flex 2xl:justify-around   2xl:mb-20 xl:mb-5 lg:mb-5 md:flex-col md:justify-center md:mb-5 sm:flex-col sm:justify-center sm:mb-5  flex-col justify-center">
              <div className="2xl:w-3/12 lg:w-2/12 xl:w-2/12 md:w-full sm:w-full pt-5 md:pt-0 lg:py-0">
                <Image src={leaves} className="mx-auto 2xl:w-10 md:w-12 sm:w-8 w-8" />
              ...
              <div className="2xl:w-5/12 xl:w-6/6 lg:w-3/6   md:flex md:justify-center   sm:flex sm:justify-center  flex justify-center ">
                <div className="flex justify-around 2xl:justify-between  lg:w-full lg:m-0 xl:w-[70%]  2xl:w-[90%] xl:m-0 md:w-8/12 md:my-5 sm:w-6/12 sm:my-5 w-full ">
                  <div className="">
                    <h1
                      className="2xl:text-[30px] 2xl:mb-6 xl:text-[20px] xl:mb-4  lg:text-[18px] lg:mb-3 md:text-[20px] md:mb-2  sm:text-[12px] sm:mb-2 text-[20px]"
                      id="nav-head"
                    >
                      Quick links
                    </h1>
                    <li  className="list-none cursor-pointer  2xl:my-2 2xl:leading-[27px] 2xl:text-[25px] text-[#555555] xl:my-1 xl:leading-[20px] xl:text-[16px] lg:my-1 lg:leading-[25px] lg:text-[16px] md:my-1 md:leading-[25px] md:text-[16px]  sm:my-1 sm:leading-[20px] sm:text-[12px] text-[16px] leading-[25px]">
                      Home
                    </li>
                    <li  className="list-none cursor-pointer  2xl:my-2 2xl:leading-[35px] 2xl:text-[25px] text-[#555555] xl:my-1 xl:leading-[25px] xl:text-[16px]  lg:my-1 lg:leading-[25px] lg:text-[16px]  md:my-1 md:leading-[25px] md:text-[16px]    sm:my-1 sm:leading-[20px] sm:text-[12px] text-[16px] leading-[25px]">
                      Shop Teas
                    </li>
                    <li  className="list-none cursor-pointer  2xl:my-2 2xl:leading-[35px] 2xl:text-[25px] text-[#555555] xl:my-1 xl:leading-[25px] xl:text-[16px]  lg:my-1 lg:leading-[25px] lg:text-[16px]  md:my-1 md:leading-[25px] md:text-[16px]  sm:my-1 sm:leading-[20px] sm:text-[12px] text-[16px] leading-[25px]">
                      About Me
                  ...
                  <div>
                    <h1
                      className="2xl:text-[30px] 2xl:mb-4 xl:text-[20px] xl:mb-4  lg:text-[18px] lg:mb-3 md:text-[20px] md:mb-2 sm:text-[12px] sm:mb-2 text-[20px]"
                      id="nav-head"
                    >
                      My Account
                    </h1>
              ...
              <div className="flex justify-center my-3 md:flex md:justify-center sm:flex sm:justify-center lg:w-4/12 lg:flex-none xl:flex-none xl:w-3/12 2xl:w-3/12 ">
                <div className="lg:w-10/12 xl:w-full 2xl:w-full relative md:w-4/12 sm:w-4/12 ">
                  <h1
                    className="2xl:text-[30px] 2xl:mb-2 xl:text-[20px] xl:mb-2  lg:text-[18px] lg:mb-2 md:text-[20px] md:mb-2 sm:text-[12px] sm:mb-2 text-[20px] my-1"
                    id="nav-head"
                  >
                  ...
                  <div className="flex justify-center md:justify-center lg:justify-start sm:justify-center 2xl:gap-7  2xl:my-4 xl:gap-5  xl:my-3 lg:my-2 lg:gap-4 md:my-5 sm:my-5 md:w-11/12  md:gap-4 sm:gap-4 my-2 gap-4  ">
                    ...
                    <Link
                      ...
                      target="_blank"
                    >
                      <Image src={fbb} className=" 2xl:w-10 xl:w-5 lg:w-5 md:w-7 w-6" />
                    </Link>
                    <Link
                    ...
                    <Link href="https://www.youtube.com/" target="_blank">
                      <Image src={YTt} className=" 2xl:w-12 xl:w-6 lg:w-6 md:w-8 w-7" />
                    </Link>
                  </div>
                </div>
              </div>
            ...
            <h1 className=" 2xl:text-[25px]  2xl:leading-[24px] xl:text-[16px]  xl:leading-[20px] xl:pb-4 lg:text-[16px]  lg:leading-[20px] lg:pb-4 text-[#666666] text-center  2xl:pb-5 md:text-[16px]  md:leading-[20px] md:pb-4  sm:text-[12px]  sm:leading-[20px] sm:pb-4 text-[16px] my-1 pb-3">
