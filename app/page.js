      ...
      <section>
        <div className="">
          ...
          >
            ...
            <div
              className="2xl:w-[1500px] xl:w-[1000px]  lg:w-[750px]  lg:mx-auto   md:ml-24 sm:ml-20 my-auto
               "
            >
              {/* 2xl:ml-56
              xl:ml-40
          ...
          <div className="flex justify-center  2xl:mt-[100px] xl:mt-16 lg:mt-16 md:mt-10 sm:mt-6 my-3">
            <div className="2xl:w-[1500px] xl:w-[1000px]  lg:w-[750px]   mx-auto  ">
              <Image
                src={leaves}
                className="mx-auto 2xl:w-[57.7px] 2xl:h-[51.91px] xl:w-[35px] lg:w-[25px] sm:w-8 w-8"
              />
              <h1
                id="head"
                className="text-[#1E1E1E] 2xl:text-[60px] text-center 2xl:leading-[70px] 2xl:mt-7 xl:text-[40px] xl:leading-[35px] xl:mt-1 lg:text-[30px] lg:leading-[40px] lg:mt-1 md:text-[30px] md:leading-[30px] md:mt-2 sm:text-[28px] sm:leading-[25px] sm:mt-2 text-[25px] leading-[30px] "
              >
                Unique Herbs and Spices
              </h1>
              <h2
                id="head"
                className="text-center 2xl:text-[36px]  2xl:leading-[56px]  xl:text-[24px]  xl:leading-[30px] xl:mt-1 lg:text-[18px]  lg:leading-[20px] lg:my-1 md:text-[18px]  md:leading-[22px] md:my-2 sm:text-[16px]  sm:leading-[20px] sm:my-1  text-[18px]  leading-[20px] my-1"
              >
                No Added Flavors
              </h2>
              <p
              ...
              <div className=" mx-auto 2xl:mt-[74px] xl:mt-10 lg:mt-8 md:mt-4 sm:mt-4 mt-3">
                <div className="flex  flex-wrap 2xl:gap-20 justify-center lg:justify-between md:flex-row md:gap-8 flex-col sm:gap-6">
                  ...
                  >
                    ...
                    <h1
                      id="head"
                      className="text-[#1E1E1E] text-center 2xl:text-[24px] 2xl:mt-[18px] 2xl:leading-[50px]  xl:text-[16px] xl:my-2 xl:leading-[35px] lg:my-2 lg:text-[14px]  lg:leading-[25px] md:text-[16px] md:my-1  md:leading-[25px] sm:text-[14px] sm:mt-1 sm:leading-[30px]  text-[16px]  leading-[25px ]"
                    >
                      Weight Wonder
                    </h1>
                    <h1
                      id="head"
                      className="text-center 2xl:my-3  2xl:text-[36px] 2xl:leading-[25px]  xl:text-[22px] xl:my-2 xl:leading-[20px] lg:text-[20px]  lg:leading-[25px] md:text-[18px] md:my-1 md:leading-[25px] sm:text-[18px] sm:leading-[25px]   text-[14px]  leading-[20px] "
                    >
                      $17.00
                    </h1>
                  </div>
                  ...
                  >
                    ...
                    <h1
                      id="head"
                      className="text-[#1E1E1E] text-center 2xl:text-[24px] 2xl:mt-[18px] 2xl:leading-[50px]  xl:text-[16px] xl:mt-2 xl:leading-[35px] lg:my-2 lg:text-[14px]  lg:leading-[25px] md:text-[16px] md:my-1  md:leading-[25px] sm:text-[14px] sm:mt-1 sm:leading-[30px]  text-[16px]  leading-[25px ]"
                    >
                      Champion Chai
                    </h1>
                    <h1
                      id="head"
                      className="text-center 2xl:my-12xl:my-3  2xl:text-[36px] 2xl:leading-[25px]  xl:text-[22px] xl:my-2 xl:leading-[20px] lg:text-[20px]  lg:leading-[25px] md:text-[18px] md:my-1 md:leading-[25px] sm:text-[18px] sm:leading-[25px]   text-[14px]  leading-[20px] "
                    >
                      $17.00
                    </h1>
                  </div>
                  ...
                  >
                    ...
                    <h1
                      id="head"
                      className="text-[#1E1E1E] text-center 2xl:text-[24px] 2xl:mt-4 2xl:leading-[50px] xl:text-[16px] xl:my-2 xl:leading-[35px] lg:my-2 lg:text-[14px]  lg:leading-[25px] md:text-[16px] md:my-1  md:leading-[25px] sm:text-[14px] sm:mt-1 sm:leading-[30px]  text-[16px]  leading-[25px ]"
                    >
                      Anxiety Assist
                    </h1>
                    <h1
                  ...
                  >
                    ...
                    <h1
                      id="head"
                      className="text-center 2xl:text-[24px] 2xl:mt-[18px] 2xl:leading-[50px]   xl:text-[16px]  xl:leading-[35px] lg:text-[14px]  lg:leading-[25px] md:text-[16px]  md:leading-[25px] md:my-1 sm:text-[14px]  sm:leading-[30px] text-[16px]  leading-[25px]"
                    >
                      Immune Boost Beast
                    </h1>
                    <h1
              ...
              <div className="2xl:w-[1500px] xl:w-[1000px]  lg:w-[750px]   mx-auto ">
                ...
                <div className="flex flex-col  justify-between  mx-auto  sm:flex-col sm:w-1/3 sm:mx-auto 2xl:mt-4 xl:mt-1  lg:w-full  lg:flex-row">
                  <div className="  w-1/3 mx-auto sm:w-full lg:w-1/3  ">
                    <h1
                      className="text-center  bg-[#5C161D]  2xl:mt-[36%]  text-white rounded-[8px]  2xl:w-[300px] 2xl:py-[15px]  2xl:text-[18px] 2xl:mr-20 2xl:leading-[28px]  mx-auto  xl:w-[200px] xl:mr-20  lg:mr-10  xl:py-2  xl:text-[14px] xl:leading-[20px] xl:mt-24   lg:w-8/12 lg:py-[6px]  lg:text-[12px] lg:leading-[20px] lg:mt-20  md:w-9/12 md:py-[5px]  md:text-[14px] md:leading-[22px] md:mt-1  sm:w-9/12 sm:py-1  sm:text-[12px] sm:leading-[15px] sm:mt-1  w-11/12 py-[6px]  text-[16px] leading-[30px] mt-10  "
                      id="head"
                    >
                      Immune Boost Beast
                    </h1>
                    <h1
                      className=" text-white  rounded-[8px] 2xl:w-[300px] 2xl:py-[15px]  2xl:mt-[25%]  text-center  bg-[#A47750] 2xl:text-[18px] 2xl:mr-[175px]  2xl:leading-[28px] xl:py-2 xl:mr-20 xl:text-[14px] xl:leading-[20px] xl:mt-20 xl:w-[200px] lg:py-[6px] lg:w-8/12  lg:text-[12px] lg:leading-[20px] lg:mt-14 lg:ml-0  md:w-9/12 md:py-[5px]  md:text-[14px] md:leading-[22px] md:mt-12 sm:mx-auto sm:w-9/12 sm:py-1  sm:text-[12px] sm:leading-[15px] sm:mt-8  py-[6px]  text-[16px] leading-[30px] mt-12 w-11/12 "
                      id="head"
                    >
                      Champion Chai
                    </h1>
                    <h1
                      className=" text-white rounded-[8px]  w-11/12 2xl:py-[15px]  2xl:mt-[25%]  text-center  bg-[#7A8654] 2xl:w-[300px] 2xl:text-[18px] 2xl:mr-20 2xl:leading-[28px]  mx-auto  xl:mr-20  lg:mr-10  xl:py-2  xl:text-[14px] xl:leading-[20px] xl:mt-20 xl:w-[200px] lg:py-[6px] lg:w-8/12  lg:text-[12px] lg:leading-[20px] lg:mt-14  md:w-9/12 md:py-[5px]  md:text-[14px] md:leading-[22px] md:mt-12   sm:w-9/12 sm:py-1  sm:text-[12px] sm:leading-[15px] sm:mb-0 py-[6px]  text-[16px] leading-[30px] mt-12"
                      id="head"
                    >
                      Weight Wonder
                    </h1>
                  ...
                  <div
                    ...
                    className="border  w-1/3 mx-auto mt-10 rounded-[14px] 2xl:w-[550px] 2xl:mt-4
                     shadow-2xl 2xl:p-10 2xl:pb-3 xl:w-1/3 xl:px-10 xl:py-6 xl:pb-0 lg:px-6 lg:mt-0 lg:w-1/3 lg:py-4 lg:pb-0 md:px-5 md:py-3 md:mt-10 sm:mt-10 md:pb-0 sm:px-5 sm:py-3 sm:pb-0 sm:w-full sm:my-2 px-3 py-1 pb-0  "
                  >
                    <h1
                      id="head"
                    ...
                    <h1
                      id="head"
                      className="text-center  2xl:text-[36px] 2xl:leading-[37px] 2xl:mt-[30px]   xl:text-[25px] xl:leading-[30px] xl:mt-4 lg:mt-3 lg:text-[20px] lg:leading-[25px]  md:mt-3 md:text-[18px] md:leading-[20px]   sm:mt-1 sm:text-[18px] sm:leading-[25px]    mt-1 text-[18px] leading-[20px] "
                    >
                      {" "}
                      $15.00
                    </h1>
                    ...
                    <div className="flex justify-center">
                      <button className="bg-black  2xl:my-6   2xl:px-10  xl:mt-4 xl:px-0  lg:my-4 lg:px-0  md:my-4 md:px-0  sm:my-2 sm:px-0 my-2 btn-curv">
                        <p
                          className="text-white 2xl:text-[20px] 2xl:leading-[22px] 2xl:py-[14px] 2xl:px-[16px]  xl:text-[14px] xl:leading-[20px] xl:py-[2px] xl:px-10 lg:text-[12px] lg:leading-[16px]  lg:px-[24px]  md:text-[10px] md:leading-[12px] md:py-[2px] md:px-[16px] sm:text-[6px] sm:leading-[8px] sm:py-[0px] sm:px-[14px] text-[14px] leading-[20px] py-[7px] px-[20px] my-2 "
                          id="head"
                        >
                          Buy Now
                        </p>
                  ...
                  <div className=" w-1/3 mx-auto flex flex-col   sm:w-full lg:w-1/3">
                    <h1
                      className="  text-white  bg-[#32504D] 2xl:mt-[36%] text-center rounded-[8px] mx-auto w-11/12 2xl:w-[300px] 2xl:py-[15px]   2xl:text-[18px] 2xl:ml-[80px] 2xl:leading-[28px] xl:ml-20 xl:mt-24 xl:py-2 xl:text-[14px] xl:leading-[20px] xl:w-[200px]   lg:ml-10  lg:py-[6px] lg:w-8/12  lg:text-[12px] lg:leading-[20px] lg:mt-20 md:w-9/12 md:py-[5px]  md:text-[14px] md:leading-[22px] md:mt-12  sm:w-9/12 sm:py-1  sm:text-[12px] sm:leading-[15px] sm:mt-10  py-[6px]  text-[16px] leading-[30px] mt-10"
                      id="head"
                    >
                      Anxiety Assist
                    </h1>
                    <h1
                      className="   text-white rounded-[8px]  w-11/12 text-center bg-[#482E69] 2xl:py-[15px] 2xl:w-[300px] 2xl:text-[18px] 2xl:mt-[25%] 2xl:leading-[28px] 2xl:ml-[180px]  xl:py-2  xl:text-[14px] xl:leading-[20px ] xl:w-[200px] xl:mr-0 xl:mt-20 lg:mr-0  lg:w-8/12    lg:mt-14 lg:py-[6px] lg:text-[12px] lg:leading-[20px] md:w-9/12 md:py-[5px]  md:mx-auto md:text-[14px] md:leading-[22px] md:mt-12   sm:w-9/12 sm:py-1  sm:text-[12px] sm:leading-[15px] sm:mt-8 sm:mx-auto  py-[6px]  text-[16px] leading-[30px] mt-10"
                      id="head"
                    >
                      Flair Fighter
                    </h1>
                    <h1
                      className=" text-white rounded-[8px]  mx-auto  w-11/12 text-center  bg-[#7D062A] 2xl:w-[300px] 2xl:py-[15px] 2xl:mt-[25%]  2xl:text-[18px] 2xl:ml-[80px] 2xl:leading-[28px] xl:ml-20 xl:mt-20 xl:py-2  xl:text-[14px] xl:leading-[20px] xl:w-[200px]  lg:ml-10  lg:py-[6px]  lg:w-8/12  lg:text-[12px] lg:leading-[20px] lg:mt-14 md:w-9/12 md:py-[5px]  md:text-[14px] md:mx-auto  md:leading-[22px] md:mt-12  sm:w-9/12 sm:py-1  sm:text-[12px] sm:leading-[15px] sm:mt-8  py-[6px]  text-[16px] leading-[30px] mt-12"
                      id="head"
                    >
                      Detox Delite
                    </h1>
            ...
            <div className="2xl:w-[1500px] xl:w-[1000px]  lg:w-[750px]   mx-auto lg:flex  lg:justify-around lg:flex-row  xl:flex xl:flex-row  2xl:mx-auto 2xl:flex 2xl:justify-around   2xl:mb-10 xl:mb-2 lg:mb-8 md:flex-col md:justify-center md:mb-10 sm:flex-col sm:justify-center sm:mb-5  flex-col justify-center">
              ...
              >
                <div className=" lg:w-10/12 xl:w-full 2xl:w-full  md:w-4/12 sm:w-4/12 ">
                  <h1
                    className="list-none cursor-pointer  2xl:my-4 2xl:leading-[27px] 2xl:text-[18px] text-[##1E1E1E] xl:mt-2 xl:leading-[20px] xl:text-[14px] lg:my-2 lg:leading-[18px] lg:text-[12px] md:my-1 md:leading-[18px] md:text-[12px]  sm:my-1 sm:leading-[10px] sm:text-[10px] text-[10px] leading-[18px]"
                    id="b-font"
                  >
                  ...
                  <Image
                    src={arrow}
                    className="absolute z-20 ml-56 mt-2 2xl:w-5  2xl:ml-[345px]  2xl:mt-7 2xl:mb-4 xl:w-4  xl:ml-[225px]  xl:mt-5 lg:ml-[180px] lg:mt-[18px] md:mt-3 md:ml-52 sm:mt-2 sm:ml-48 "
                  />
                  <input
                    type="text"
                    placeholder="Email"
                    className=" cursor-pointer border relative border-[#315031] bg-[#E9F5DE]  rounded  2xl:w-full 2xl:mt-3 2xl:p-[11px] xl:w-full xl:mt-3 xl:p-0.5  lg:w-full lg:p-0.5 lg:mt-2 w-full px-1 md:p-1 md:w-11/12"
                  />
                  <div className="flex justify-center md:justify-center lg:justify-start sm:justify-center 2xl:gap-7  2xl:my-5 xl:gap-5  xl:my-3 lg:my-2 lg:gap-4 md:my-5 sm:my-5 md:w-11/12  md:gap-4 sm:gap-4 my-2 gap-4  ">
                    <Link href="https://twitter.com/" target="_blank">
                      <Image
                        src={twitter}
                        className=" 2xl:w-5 xl:w-6 lg:w-4 md:w-4 w-5"
                      />
                    </Link>
                    <Link
                    ...
                    >
                      <Image
                        src={insta}
                        className=" 2xl:w-5 xl:w-6 lg:w-4 md:w-[16px] w-5"
                      />
                    </Link>
                    <Link
                    ...
                    >
                      <Image
                        src={music}
                        className=" 2xl:w-5 xl:w-[22px] lg:w-4 md:w-4 w-5"
                      />
                    </Link>
                    <Link href="https://www.youtube.com/" target="_blank">
                      <Image
                        src={YTt}
                        className=" 2xl:w-6 xl:w-6 lg:w-[18px] md:w-[16px] w-5"
                      />
                    </Link>
                  </div>
                </div>
