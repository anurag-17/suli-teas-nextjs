      ...
      <section>
        <div>
          <div className="h-screen" id="bg-poster">
            ...
            <div className="2xl:mt-80 2xl:ml-56 xl:mt-56 xl:ml-40 lg:mt-40 lg:ml-32  md:mt-32 md:ml-28 sm:mt-24 sm:ml-16 mt-28 ml-16">
              <h1
                id="p-font"
              ...
              <h1
                id="p-font"
                className="2xl:text-[80px] 2xl:mt-1 2xl:leading-[90px] text-[#1E1E1E]  xl:text-[48px] xl:leading-[55px] lg:text-[40px] lg:leading-[32px] md:text-[35px] md:leading-[35px] sm:text-[28px] sm:leading-[25px] text-[20px] leading-[25px]"
              >
                Curated{" "}
              </h1>
              <h1
                ...
                text-[25px] leading-[20px]"
              >
                Herbal Teas
              </h1>
              <p
                id="nav-head"
                className="2xl:text-[18px] 2xl:mt-5 2xl:leading-[23px] xl:text-[13px] xl:mt-2 xl:leading-[23px] lg:text-[10.5px] lg:mt-0 lg:leading-[20px] md:text-[9px] md:mt-0 md:leading-[20px] sm:text-[7px] sm:mt-0 sm:leading-[14px] text-[5px] mt-0 leading-[14px]"
              >
              ...
              <button className="bg-black 2xl:my-6 2xl:px-10 rounded-bl-full rounded-tr-full xl:my-2 xl:px-6 lg:my-2 lg:px-5 md:my-2 md:px-5 sm:my-2 sm:px-3 ">
                <h1
                  ...
                  lg:text-[14px] lg:leading-[14px] lg:py-[7px] lg:px-[5px] sm:text-[10px] sm:leading-[14px] sm:py-[5px] sm:px-[3px] text-[8px] leading-[12px] py-[3px] px-[7px]"
                  id="b-font"
                >
                  Buy Now
                </h1>
          ...
          <div className="flex justify-center 2xl:mt-24 xl:mt-16 lg:mt-16 md:mt-10 sm:mt-6 mt-3">
            <div className="">
              ...
              <p
                ...
                leading-[8px] sm:text-[7px] sm:mt-2 sm:w-4/12 text-[6px] mt-1 w-6/12
              "
              >
              ...
              <div className=" w-10/12 mx-auto 2xl:mt-20 xl:mt-8 lg:mt-6 md:mt-4 sm:mt-4 mt-3">
                <div className="flex justify-center flex-wrap gap-4  sm:justify-around md:gap-6 sm:gap-6">
                  <div className="2xl:mb-8 xl:w-1/4 lg:w-1/4 md:w-2/6 sm:w-2/6 w-3/6">
                    ...
                    <h1
                      id="head"
                      className="text-center 2xl:text-[24px]  2xl:leading-[37.5px] xl:text-[16px]  xl:leading-[35px]  lg:text-[14px]  lg:leading-[30px] md:text-[12px]  md:leading-[25px] sm:text-[10px]  sm:leading-[20px] text-[8px]  leading-[15px] text-[8px]  leading-[15px]"
                    >
                      Weight Wonder
                    </h1>
                    <h1
                      id="head"
                      className="text-center 2xl:text-[36px] 2xl:leading-[37.5px]  xl:text-[22px] xl:leading-[20px] lg:text-[18px] lg:leading-[20px] md:text-[16px] md:leading-[20px] sm:text-[14px] sm:leading-[20px] text-[10px] leading-[15px]   text-[10px] leading-[15px]  "
                    >
                      $17.00
                    </h1>
                  </div>
                  <div className="2xl:mb-8 xl:w-1/4 lg:w-1/4 md:w-2/6 sm:w-2/6 w-3/6">
                    ...
                    <h1
                      id="head"
                      className="text-center 2xl:text-[24px]  2xl:leading-[37.5px] xl:text-[16px]  xl:leading-[35px] lg:text-[14px]  lg:leading-[30px] md:text-[12px]  md:leading-[25px] sm:text-[10px]  sm:leading-[20px] text-[8px]  leading-[15px]"
                    >
                      Detox Delite
                    </h1>
                    <h1
              ...
              >
                <h1
                  id="head"
                  className="2xl:text-[50px] text-center 2xl:pt-24 2xl:leading-[70px] xl:text-[32px] xl:pt-10 xl:leading-[70px] lg:text-[25px] lg:pt-10 lg:leading-[70px] md:text-[20px] md:pt-5 md:leading-[40px] sm:text-[16px] sm:pt-5 sm:leading-[40px] text-[16px] pt-5 leading-[40px]"
                >
                  Find Your Favorite
                </h1>
                <div className="flex justify-center 2xl:mt-4 xl:mt-1 lg:mt-1">
                  <div className="  w-3/12">
                    <h1
                      className="text-center  bg-[#5C161D] 2xl:my-32 text-white rounded-[8px]  2xl:w-7/12 2xl:py-3  2xl:text-[18px] 2xl:leading-[28px]  mx-auto xl:w-7/12 xl:py-3  xl:text-[14px] xl:leading-[20px] xl:mt-28   lg:w-7/12 lg:py-2  lg:text-[12px] lg:leading-[20px] lg:mt-20 md:w-7/12 md:py-1  md:text-[10px] md:leading-[16px] md:mt-12  sm:w-8/12 sm:py-1  sm:text-[8px] sm:leading-[12px] sm:mt-10  w-8/12 py-1  text-[7px] leading-[10px] mt-10 "
                      id="head"
                    >
                      Immune Boost Beast
                    </h1>
                    <h1
                      className="2xl:my-32 text-white rounded-[8px]  w-7/12 2xl:py-3 text-center  bg-[#A47750] 2xl:text-[18px] 2xl:leading-[28px]  2xl:ml-6  xl:py-3  xl:text-[14px] xl:leading-[20px] xl:mt-16  lg:py-2  lg:text-[12px] lg:leading-[20px] lg:mt-12  md:w-7/12 md:py-1  md:text-[10px] md:leading-[16px] md:mt-10  sm:w-8/12 sm:py-1  sm:text-[8px] sm:leading-[12px] sm:mt-8  py-1  text-[7px] leading-[10px] mt-6"
                      id="head"
                    >
                      Champion Chai
                    </h1>
                    <h1
                      className="2xl:my-32 text-white rounded-[8px]  w-7/12 2xl:py-3 text-center  bg-[#7A8654] 2xl:text-[18px] 2xl:leading-[28px]  mx-auto  xl:py-3  xl:text-[14px] xl:leading-[20px] xl:mt-16  lg:py-2  lg:text-[12px] lg:leading-[20px] lg:mt-12  md:w-7/12 md:py-1  md:text-[10px] md:leading-[16px] md:mt-10   sm:w-8/12 sm:py-1  sm:text-[8px] sm:leading-[12px] sm:mt-8  py-1  text-[7px] leading-[10px] mt-6"
                      id="head"
                    >
                      Weight Wonder
                    </h1>
                  </div>
                  <div className="border rounded-[14px] shadow-2xl 2xl:p-10 2xl:pb-3 w-3/12 xl:px-10 xl:py-6 xl:pb-0 lg:px-6 lg:py-4 lg:pb-0 md:px-5 md:py-3 md:pb-0 sm:px-5 sm:py-3 sm:pb-0  px-3 py-1 pb-0 ">
                    <h1
                      id="head"
                      className="text-center 2xl:text-[24px]  2xl:leading-[39px] 2xl:mb-3 xl:text-[16px]  xl:leading-[30px] xl:mb-2  lg:text-[14px]  lg:leading-[25px] lg:mb-1  md:text-[12px]  md:leading-[20px] md:mb-1  sm:text-[10px]  sm:leading-[20px] sm:mb-1 text-[8px]  leading-[20px] mb-1 "
                    >
                      Suli’s Sample Box
                    </h1>
                    <Image src={groupP} />
                    <h1
                      id="head"
                      className="text-center  2xl:text-[36px] 2xl:leading-[37px] 2xl:mt-6   xl:text-[25px] xl:leading-[30px] xl:mt-4 lg:mt-3 lg:text-[22px] lg:leading-[25px]  md:mt-3 md:text-[18px] md:leading-[20px]   sm:mt-1 sm:text-[14px] sm:leading-[20px]   mt-1 text-[10px] leading-[15px] "
                    >
                      {" "}
                      $15.00
                    </h1>
                    ...
                    <div className="flex justify-center">
                      <button className="bg-black  2xl:my-6   2xl:px-10 rounded-bl-full rounded-tr-full xl:mt-4 xl:px-0  lg:mt-3 lg:px-0  md:my-4 md:px-0  sm:my-2 sm:px-0 my-1 ">
                        <h1
                          className="text-white 2xl:text-[20px] 2xl:leading-[26px] 2xl:py-[20px] 2xl:px-[40px]  xl:text-[12px] xl:leading-[20px] xl:py-[6px] xl:px-[22px]  lg:text-[12px] lg:leading-[20px] lg:py-[6px] lg:px-[22px]  md:text-[10px] md:leading-[16px] md:py-[4px] md:px-[16px] sm:text-[8px] sm:leading-[12px] sm:py-[2px] sm:px-[8px] text-[6px] leading-[10px] py-[1px] px-[6px] "
                          id="head"
                        >
                          Buy Now
                        </h1>
                  ...
                  <div className=" w-3/12">
                    <h1
                      className=" text-white  bg-[#32504D] text-center rounded-[8px] mx-auto w-7/12 2xl:my-32 2xl:py-3 2xl:text-[18px] 2xl:leading-[28px]  xl:mt-28 xl:py-3 xl:text-[14px] xl:leading-[20px] lg:mt-20 lg:py-2 lg:text-[12px] lg:leading-[20px] md:w-7/12 md:py-1  md:text-[10px] md:leading-[16px] md:mt-12  sm:w-8/12 sm:py-1  sm:text-[8px] sm:leading-[12px] sm:mt-10  w-8/12 py-1  text-[7px] leading-[10px] mt-10"
                      id="head"
                    >
                      Anxiety Assist
                    </h1>
                    <h1
                      className="  text-white rounded-[8px]  w-7/12 text-center  bg-[#482E69] 2xl:py-3  2xl:my-32 2xl:text-[18px] 2xl:leading-[28px] 2xl:ml-48  xl:mt-16 xl:py-3  xl:text-[14px] xl:leading-[20px] xl:ml-36   lg:mt-12 lg:py-2 lg:text-[12px] lg:leading-[20px] lg:ml-28  md:ml-24   md:w-7/12 md:py-1  md:text-[10px] md:leading-[16px] md:mt-10   sm:w-8/12 sm:py-1  sm:text-[8px] sm:leading-[12px] sm:mt-8 sm:ml-12  ml-14 py-1  text-[7px] leading-[10px] mt-6"
                      id="head"
                    >
                      Flair Fighter
                    </h1>
                    <h1
                      className=" text-white rounded-[8px]  mx-auto  w-7/12 text-center  bg-[#7D062A] 2xl:py-3  2xl:my-32 2xl:text-[18px] 2xl:leading-[28px]  xl:mt-16 xl:py-3  xl:text-[14px] xl:leading-[20px] lg:py-2 lg:my-32 lg:text-[12px] lg:leading-[20px] lg:mt-12 md:w-7/12 md:py-1  md:text-[10px] md:leading-[16px] md:mt-10  sm:w-8/12 sm:py-1  sm:text-[8px] sm:leading-[12px] sm:mt-8  py-1  text-[7px] leading-[10px] mt-6"
                      id="head"
                    >
                      Detox Delite
                    </h1>
          ...
          <div className="flex justify-center 2xl:mt-12 xl:mt-12 lg:mt-6">
            <div className=" ">
              <div className="mt-12">
                ...
                <h1
                  className=" text-[20px] text-center 2xl:text-[60px] 2xl:leading-[70px] 2xl:mt-1 xl:text-[40px] xl:leading-[40px] xl:mt-1 lg:text-[30px] lg:leading-[30px] lg:mt-1 md:text-[25px] md:leading-[25px] md:mt-1  sm:text-[20px] sm:leading-[20px] sm:mt-1"
                  id="head"
                >
                  #SuliTeas
                </h1>
              </div>
              <div className="flex  sm:flex-row gap-4 2xl:gap-4 2xl:mt-16 xl:mt-6 lg:mt-4 md:mt-2 sm:mt-1 mt-1 flex-col">
                <Image
                  src={aa}
                ...
                />
                 <Image
                  src={instagram}
                  className=" 2xl:w-8 xl:w-6  lg:w-5 md:w-4 sm:w-4  absolute sm:ml-[300px] sm:mt-[50px]  md:ml-[340px] md:mt-[55px]  lg:ml-[380px] lg:mt-[60px]  xl:ml-[499px] xl:mt-[84px]  2xl:ml-[740px] 2xl:mt-[135px] mt-100px z-10 "
                />
                <Image
                  src={cc}
                ...
                <div className="lg:w-full xl:w-full 2xl:w-full relative md:w-4/12 sm:w-4/12 ">
                  ...
                  <div className="flex justify-center md:justify-center lg:justify-start sm:justify-center 2xl:gap-7  2xl:my-4 xl:gap-5  xl:my-3 lg:my-2 lg:gap-4 md:my-5 sm:my-5   md:gap-4 sm:gap-4 my-2 gap-2 ">
                    <Link href="https://twitter.com/" target="_blank">
                      <Image src={twitter} className=" 2xl:w-8 xl:w-6 lg:w-6 w-5" />
                    </Link>
                    <Link
                    ...
                    <Link
                      ...
                      target="_blank"
                    >
                      <Image src={insta} className=" 2xl:w-7 xl:w-5 lg:w-5 w-4" />
                    </Link>
                    <Link
                      href="https://accounts.spotify.com/en/login"
                      target="_blank"
                    >
                      <Image src={music} className=" 2xl:w-6 xl:w-4 lg:w-4 w-3" />
                    </Link>
