...
const page = () => {
  return (
    <>
      <Navbar />
      <div className="2xl:w-[1300px] xl:w-[1000px]  lg:w-[750px] md:w-[620px] sm:w-[600px] w-[420px] flex justify-between m-auto ">
        <div className=" mx-auto">
          <h1 className="font-semibold  text-[40px] my-10 text-center">
            Terms of service
          </h1>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">OVERVIEW</p>

          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            This website is operated by Suli Teas. Throughout the site, the
            terms “we”, “us” and “our” refer to Suli Teas. Suli Teas offers this
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 1 - ONLINE STORE TERMS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 2 - GENERAL CONDITIONS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">Prices for our products are subject to change without notice.</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">For more detail, please review our Returns Policy.</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 7 - OPTIONAL TOOLS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 8 - THIRD-PARTY LINKS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 10 - PERSONAL INFORMATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            Your submission of personal information through the store is
            governed by our Privacy Policy. To view our Privacy Policy, please
            see [LINK TO PRIVACY POLICY]
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 12 - PROHIBITED USES</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            In no case shall Suli Teas, our directors, officers, employees,
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 14 - INDEMNIFICATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            You agree to indemnify, defend and hold harmless Suli Teas and our
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 15 - SEVERABILITY</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 16 - TERMINATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 17 - ENTIRE AGREEMENT</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 18 - GOVERNING LAW</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            These Terms of Service and any separate agreements whereby we
            provide you Services shall be governed by and construed in
            accordance with the laws of the United States.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 19 - CHANGES TO TERMS OF SERVICE</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            By consenting to Suli Teas’ SMS marketing in the checkout and
            initializing a purchase or subscribing via our subscription tools,
            you agree to receive recurring text notifications (for your order,
            including abandoned checkout reminders), text marketing offers, and
            transactional texts, including requests for reviews from us, even if
            your mobile number is registered on any state or federal do-not-call
            list. Message frequency varies. Consent is not a condition of
            purchase.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            If you wish to unsubscribe from receiving text marketing messages
            and notifications, reply with STOP to any mobile message sent from
            us or use the unsubscribe link we provided you within any of our
            messages. You understand and agree that alternative methods of
            opting out, such as using alternative words or requests, will not be
            considered a reasonable means of opting out. We do not charge for
            the service, but you are responsible for all charges and fees
            associated with text messaging imposed by your wireless provider.
            Message and data rates may apply.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            For any questions, please text HELP to the number you received the
            messages from. You can also contact us at
            https://suliteas.com/pages/contact for more information.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            We have the right to modify any telephone number or short code we
            use to operate the service at any time. You will be notified on such
            occasions. You agree that any messages you send to a telephone
            number or short code we have changed, including any STOP or HELP
            requests, may not be received, and we will not be liable for
            honoring requests made in such messages.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            To the extent permitted by applicable law, you agree that we will
            not be liable for failed, delayed, or misdirected delivery of any
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            Your right to privacy is important to us. You can see our Privacy
            Policy https://suliteas.com/policies/privacy-policy to determine how
            we collect and use your personal
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">Arbitration:</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            By using or purchasing our products or services, you agree that any
            controversy, claim, action, or dispute between you and Suli Teas
            Arising out of or relating to: (a) these Terms, or the breach
            thereof; or (b) your access to or use of our website or the services
            or the materials; or (c) any alleged violation of any federal or
            state or local law, statute or ordinance (each such controversy or
            claim, a “Claim”), shall be resolved exclusively through binding
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            ...
            to submit their disputes and potential disputes to a neutral third
            person (called an arbitrator) for a binding decision, instead of
            having such dispute(s) decided in a lawsuit, in court, by a judge or
            jury trial. The arbitrator is obligated to issue a reasoned award in
            writing, including all findings of fact and law upon which the award
            was made. The arbitrator shall not have the power to commit errors
            of law, and the arbitrator’s award may be vacated or corrected
            through judicial review by a court of competent jurisdiction. Each
            party’s attorneys’ fees, expert costs, and other costs and expenses
            incurred in connection with arbitration will be borne by the party
            incurring such costs and expenses.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">Arbitration Procedures:</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            Claims shall be heard by a single arbitrator. Arbitrations shall be
            held in Kern, CA, USA, but the parties may choose whether to appear
            in person, by phone, or through the submission of documents. The
            arbitration shall be governed by the Federal Arbitration Act (“FAA”)
            and by the internal laws of the CA,, without regard to conflicts of
            laws principles. Any disputes in this regard shall be resolved
            exclusively by an arbitrator. If, but only if, the arbitrator
            determines the FAA does not apply, New York law governing
            arbitration agreements will apply. All disputes with respect to
            whether the foregoing mutual arbitration provisions are
            unenforceable, unconscionable, applicable, valid, void or voidable
            shall be determined exclusively by an arbitrator, and not by any
            court.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">Exclusion from Arbitration:</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            Notwithstanding the terms of this Arbitration Agreement, you may
            choose to pursue a Claim in court and not by arbitration if you
            opt-out of these arbitration procedures within 30 days from the date
            that you first purchase any of our products or services (the
            “Opt-Out Deadline”). You may opt out by mailing a written
            notification to 8200 Stockdale HWY STE M-10 138. Your written
            notification must include (1) your name, (2) your address, and (3) a
            clear statement that you do not wish to resolve disputes through
            arbitration. Your decision to opt-out will have no adverse effect on
            your relationship with Suli Teas. You are responsible for ensuring
            our receipt of your opt-out notice, and you therefore may wish to
            send a notice by means that provide a written receipt. Any opt-out
            request received after the Opt-Out Deadline will not be valid and
            you must pursue your Claim in arbitration.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">Class Action Waiver:</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            You and Suli Teas agree that you may bring or participate in Claims
            against us only in your respective individual capacity, and not as a
            plaintiff or class member in any purported class, consolidated, or
            representative proceeding. Unless both you and Suli Teas agree
            otherwise in writing, the arbitrator may not consolidate or join the
            claims of other persons or parties who may be similarly situated and
            may not otherwise preside over any form of a representative or class
            proceeding. Notwithstanding any other clause contained in this
            Agreement, any Claim that all or part of this Class Action Waiver is
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">SECTION 20 - CONTACT INFORMATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-12 2xl:leading-8">
            Questions about the Terms of Service should be sent to us at
            info@suliteas.com.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-4 2xl:leading-8">Our contact information is posted below:</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-4 2xl:leading-8">Suli Teas</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-4 2xl:leading-8">info@suliteas.com</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-4 2xl:leading-8">8200 Stockdale hwy M10-138</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-4 2xl:leading-8">Bakersfield, CA 93309</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-16 my-16 2xl:leading-8">[INSERT VAT NUMBER]</p>
