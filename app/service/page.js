    ...
    <>
      ...
      <div className="2xl:mt-[150px] xl:mt-32 lg:mt-28 2xl:w-[1500px] xl:w-[1000px]  lg:w-[750px] md:w-[620px] sm:w-[600px] w-[420px] flex justify-between m-auto ">
        <div className=" mx-auto" data-aos="fade-up">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">OVERVIEW</p>

          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 1 - ONLINE STORE TERMS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 2 - GENERAL CONDITIONS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">Prices for our products are subject to change without notice.</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">For more detail, please review our Returns Policy.</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 7 - OPTIONAL TOOLS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 8 - THIRD-PARTY LINKS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 10 - PERSONAL INFORMATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
            Your submission of personal information through the store is
            governed by our Privacy Policy. To view our Privacy Policy, please
            see [LINK TO PRIVACY POLICY]
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 12 - PROHIBITED USES</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 14 - INDEMNIFICATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 15 - SEVERABILITY</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 16 - TERMINATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 17 - ENTIRE AGREEMENT</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 18 - GOVERNING LAW</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
            These Terms of Service and any separate agreements whereby we
            provide you Services shall be governed by and construed in
            accordance with the laws of the United States.
          </p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 19 - CHANGES TO TERMS OF SERVICE</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">Arbitration:</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">Arbitration Procedures:</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">Exclusion from Arbitration:</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">Class Action Waiver:</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
          ...
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">SECTION 20 - CONTACT INFORMATION</p>
          <p className="text-[#6d6c6c] leading-7 2xl:text-[20px] 2xl:my-10 my-6 2xl:leading-8">
